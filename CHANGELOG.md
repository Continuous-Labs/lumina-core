...
### Changed
- **NPM Discovery**: Added relevant keywords to all packages to improve searchability and visibility on npmjs.com.
- **Maintenance**: Routine version bump and repository synchronization.
...
- **Svelte Showcase**: Added Svelte 5 to the framework showcase.
